...
2. **Zebra stripes.** Five tables render as plain `class="table"` with a hover tint: email templates, email send log, compose blast history, announce list. Stripe geometry is one dialect family-wide (`decisions.md:499-503`).
