...
(Archived 2026-08-07: the flip, gates, merge, and deploy all happened; see STATUS's completion
entry.)
...
loaded rolling status until then, and both are now one-paragraph stubs in STATUS.md.]**

**THE FIVE PRE-TRIAL CHORES AND THE CAIRN 0.91.0 REGRESSION THEY TURNED UP (2026-07-29,
Opus 5 conducting, plan
