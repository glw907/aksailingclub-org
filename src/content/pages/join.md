...
::::cards
:::card[Club Boats]{icon="sailboat"}
Use our fleet of Lasers, Lidos, Catalina 16.5, and Ensign 22 after qualification checkouts.
:::
:::card[Racing]{icon="flag-pennant"}
Participate in regattas and races throughout the season.
:::
:::card[Classes]{icon="graduation-cap"}
Take sailing courses from beginner to advanced at member rates.
:::
:::card[RVs & Camping]{icon="van"}
Tent camping and RV parking at our lakeside property during sailing season.
:::
:::card[Community]{icon="users-three"}
Member directory and Discord server to connect with fellow sailors.
:::
:::card[Grounds Access]{icon="tree-evergreen"}
Full seasonal access to club grounds, including the clubhouse, sauna, campfire, and docks.
:::
::::
...
### Already an Experienced Sailor?

If you're joining for the boats, the racing, or the community rather than a beginner class, you're equally welcome. Just keep in mind that all members need a qualification checkout before using club boats, even experienced sailors (see [Club Boat Use & Qualification](/club-boat-use-and-qualification/)). You can organize a time with an instructor by posting in the `#education` channel on our Discord server after joining. The [New Member Guide](/new-member-guide/) has everything else you need to get oriented.
