...
**Authority:** Internal Revenue Service, Department of the Treasury
...
- **Contributions are tax-deductible.** Donations to the club are deductible under Section 170 of the Internal Revenue Code. Membership dues may also be partially deductible — consult your tax advisor.
- **The club is a public charity**, not a private foundation, under Section 509(a)(2). This classification affects how the club can raise and spend funds.
- **The club must file Form 990 annually.** This is the IRS return for tax-exempt organizations. It is a public document — anyone can request a copy.
- **The exemption is permanent** unless the club's activities change substantially or it fails to maintain its 501(c)(3) status through proper governance and reporting.

If you need to verify the club's tax-exempt status — for a grant application, a donation receipt, or any other purpose — this letter is the document to provide.
