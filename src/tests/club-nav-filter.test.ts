...
const clubSection: ResolvedNavItem = {
  label: 'Club',
  children: [{ label: 'Events', iconName: 'calendar', href: '/admin/club/events', ownerOnly: false }],
};
const otherEntry: ResolvedNavItem = { label: 'Widgets', iconName: 'wrench', href: '/admin/widgets', ownerOnly: false };
const ITEMS: ResolvedNavItem[] = [clubSection, otherEntry];
...
const editor: Editor = { email: 'e@example.com', displayName: 'E', role: 'editor' };
