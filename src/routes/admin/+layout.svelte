<!--
@component
The shared admin shell mount: every /admin/** route renders inside CairnAdminShell, fed the
shell payload from the sibling +layout.server.ts. The catch-all view page renders as the
shell's children.
-->
<script lang="ts">
